...
export const PROJECTS = [
  {
    title: "CampusCircle",
    description: "A campus community product focused on student collaboration, updates, and peer connections.",
    tech: ["Full Stack", "Product", "Community"],
    link: "https://github.com/rudresh05/CampusCircle",
    imageUrl: "",
    featured: true,
    stars: 0,
    forks: 0,
    updatedAt: "2025-10-01T00:00:00Z",
    repoName: "CampusCircle",
  },
  {
    title: "Fullstack Portfolio",
    description: "A modern portfolio codebase built with a typed React stack and production-ready layout patterns.",
    tech: ["TypeScript", "Next.js", "React"],
    link: "https://github.com/rudresh05/fullstack-portfolio",
    imageUrl: "",
    featured: true,
    stars: 0,
    forks: 0,
    updatedAt: "2026-05-24T13:29:49Z",
    repoName: "fullstack-portfolio",
  },
  {
    title: "GitHub Pages Portfolio",
    description: "Personal GitHub Pages site for showcasing profile links, project work, and contact details.",
    tech: ["HTML", "CSS", "JavaScript"],
    link: "https://github.com/rudresh05/rudresh05.github.io",
    imageUrl: "",
    featured: false,
    stars: 0,
    forks: 0,
    updatedAt: "2026-05-10T10:39:10Z",
    repoName: "rudresh05.github.io",
  },
  {
    title: "Tree Data Structure",
    description: "Java implementations and exercises for core tree traversal, recursion, and data-structure practice.",
    tech: ["Java", "DSA", "Algorithms"],
    link: "https://github.com/rudresh05/Tree_Data_Structure",
    imageUrl: "",
    featured: false,
    stars: 1,
    forks: 0,
    updatedAt: "2025-07-21T07:25:07Z",
    repoName: "Tree_Data_Structure",
  },
  {
    title: "Recursion",
    description: "A focused Java practice repository for recursion patterns, problem solving, and fundamentals.",
    tech: ["Java", "Recursion", "DSA"],
    link: "https://github.com/rudresh05/Recursion",
    imageUrl: "",
    featured: false,
    stars: 1,
    forks: 0,
    updatedAt: "2025-07-21T07:25:05Z",
    repoName: "Recursion",
  },
  {
    title: "Learn Kotlin Basics",
    description: "Kotlin fundamentals and syntax practice for Android-ready application development.",
    tech: ["Kotlin", "Android", "Basics"],
    link: "https://github.com/rudresh05/Learn_Kotlin_Basics",
    imageUrl: "",
    featured: false,
    stars: 1,
    forks: 0,
    updatedAt: "2025-07-21T07:25:04Z",
    repoName: "Learn_Kotlin_Basics",
  },
] as const;

export const HERO_SETTINGS = {
  imageUrl: "/rudresh-portfolio.jpeg",
} as const;
